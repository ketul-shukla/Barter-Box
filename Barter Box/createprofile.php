...
if (isset($_POST['createProfileForm'])) {
	...
	$sql = "INSERT INTO barterbox.profile (firstName, lastName, emailID, password, about, location, userName) VALUES 
	('$firstName', '$lastName', '$emailID', '$password', '$about','$location','$userName')";
...
<body>
         ...
         <div class="modal-dialog">
             <div class="modal-content">
               ...
               <div class="modal-body">
                     <form role="form" name="loginform" id="loginform" method="post" action="createprofile.php">
    ...
    <div class="row">
       <div class="col-lg-8 col-lg-offset-2 col-md-12 col-md-offset-2 col-sm-12 col-xs-12">
            <form class="form-horizontal" name= "createprofileform" id="createProfileForm" action="/index.php" method="post">
   ...
   function previewFile(){
       ...
       if (file) {
           ...
           preview.src = "assests/img/profilemaledefault.png";
       }
  }

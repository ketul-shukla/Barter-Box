...
<div class="col-sm-4">
 ...
 <div class="panel panel-default"  >
                <div id="div3" class="panel-body">
					<br/>
					<br/>
					<h4>Color: <?php echo "{$row[1][8]}"?></h4>
					<h4>Brand: <?php echo "{$row[1][9]}"?></h4>
					<h4>Fabric: <?php echo "{$row[1][10]}"?></h4>
					<br/>
					<br/>
...
<div class="container text-center">    
  ...
  <div class="row">
    ...
    <div class="col-sm-2">
     ...
     <a href="furniture_details.php"><img src="<?php echo "{$row[0][3]}"?>" class="img-responsive" style="width:100%;height:100px"  alt="Image"></a>
    </div>
  </div>	

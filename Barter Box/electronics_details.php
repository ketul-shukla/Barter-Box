...
$sqlselectProds= "SELECT * FROM electronics_details WHERE sub_category = 'Laptops'";
...
<div class="col-sm-4">
 ...
 <div class="panel panel-default"  >
                <div id="div3" class="panel-body">
					...
					<h4>Warranty: <?php echo "{$row[0][8]}"?></h4>
					<h4>Color: <?php echo "{$row[0][9]}"?></h4>
					<h4>Brand: <?php echo "{$row[0][10]}"?></h4>
					<h4>Accessories provided: <?php echo "{$row[0][11]}"?></h4>
...
<div class="container text-center">    
  ...
  <div class="row">
    ...
    <div class="col-sm-2">
     ...
     <a href="electronics_details_1.php"><img src="<?php echo "{$row[1][3]}"?>" class="img-responsive" style="width:100%;height:100px"  alt="Image"></a>
    </div>
  </div>	

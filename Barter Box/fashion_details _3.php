...
$sqlselectProds= "SELECT * FROM fashion_details WHERE sub_category = 'Tops'";
...
<div class="col-sm-4">
 ...
 <div class="panel panel-default"  >
                <div id="div3" class="panel-body">
					<br/>
					<br/>
					<h4>Size: <?php echo "{$row[1][8]}"?></h4>
					<h4>Color: <?php echo "{$row[1][9]}"?></h4>
					<h4>Brand: <?php echo "{$row[1][10]}"?></h4>
					<h4>Fabric: <?php echo "{$row[1][11]}"?></h4>
  ...
  <div class="col-sm-4">
		 ...
		 <div class="panel panel-default">
                <div class="panel-body">
                    <div class="media">
                        <div align="center">
      <img src="assests/img/seller_4.jpg" class="img-responsive" style="width:200px;height:150px;" alt="Image">
                            <h3>Phoebe Buffay</h3>
                        </div>
  ...
  <div class="row">
    ...
    <div class="col-sm-2">
	 <div id="div5" class="well">
      <a href="fashion_details.php"><img src="<?php echo "{$row[0][3]}"?>" class="img-responsive" style="width:100%;height:100px"  alt="Image"></a>
    </div>
  </div>	

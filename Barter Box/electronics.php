...
<div class="row">
    ...
    <div class="select"><select name="fashion_priceRange" id="fashion_priceRange" onchange="this.form.submit()">
		...
		<option value="Greater than $500">Greater than $500</option>
			...
			<div class="well" style=" background: url(assests/img/electronicsbg1.jpg) no-repeat center fixed; background-size: cover;">
        <!-- Projects Row -->
        <div class="row">
            <div class="col-md-4 img-portfolio">
						<div class="well" style="background-color:white;">

                <a href="electronics_details.php">
                ...
                <h3 align="center">
                    <a href="electronics_details.php"><?php if($fashion_sort=="Select a value" && $fashion_subCategory=="Select a value" && $fashion_priceRange=="Select a value")
				  { echo "{$rowdefault[0][1]}";}
					else if($fashion_sort=="Price: Low to High" && $fashion_subCategory=="Select a value" &&  $fashion_priceRange=="Select a value")

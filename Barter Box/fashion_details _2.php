...
$sqlselectProds= "SELECT * FROM fashion_details WHERE sub_category = 'Shoes'";
  ...
  <div class="col-sm-4">
		 ...
		 <div class="panel panel-default">
                <div class="panel-body">
                    <div class="media">
                        <div align="center">
      <img src="assests/img/seller_3.jpg" class="img-responsive" style="width:200px;height:150px;" alt="Image">

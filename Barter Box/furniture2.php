...
$sqlselectdefault= "SELECT * FROM furniture_details";
...
$sqlselectpricelth= "SELECT * FROM furniture_details ORDER BY price";
...
$sqlselectpricehtl= "SELECT * FROM furniture_details ORDER BY price desc";
...
$sqlselectarrivals= "SELECT * FROM furniture_details ORDER BY purchase_date desc";
...
$sqlselectjackets= "SELECT * FROM furniture_details WHERE sub_category = 'Living'";
...
$sqlselecttops= "SELECT * FROM furniture_details WHERE sub_category = 'Bedroom'";
...
$sqlselectjeans= "SELECT * FROM furniture_details WHERE sub_category = 'Others'";
...
$sqlselectlessthan10= "SELECT * FROM furniture_details WHERE price BETWEEN 0 and 10";
...
$sqlselect11and50= "SELECT * FROM furniture_details WHERE price BETWEEN 11 and 50";
...
$sqlselect51and100= "SELECT * FROM furniture_details WHERE price BETWEEN 51 and 100";
...
$sqlselect101and500= "SELECT * FROM furniture_details WHERE price BETWEEN 101 and 500";
...
$sqlselectgreaterthan500= "SELECT * FROM furniture_details WHERE price > 500";
    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <div class="fill" style="background-image:url('assests/img/furniturec1.jpg');"></div>
                <div class="carousel-caption">
                    <h2></h2>
                </div>
            </div>
            <div class="item">
                <div class="fill" style="background-image:url('assests/img/furniturec2.jpg');"></div>
                <div class="carousel-caption">
                    <h2></h2>
                </div>
            </div>
            <div class="item">
                <div class="fill" style="background-image:url('assests/img/furniturec3.jpg');"></div>
                <div class="carousel-caption">
                    <h2></h2>
                </div>
            </div>
            ...
            <div class="col-lg-12">
				...
				<div class="row text-center">
				 ...
				 <ul class="pagination" >
                    ...
                    <li>
                        <a href="furniture.php">Grid</a>
                    </li>
                    <li>
                        <a href="furniture2.php">List</a>
                    </li>
                    <li>
                        <a href="furniture3.php">Map</a>
                    </li>
                </ul>
            </div>
        </div>
...
<div class="row">
    ...
    <div class="select"><select name="fashion_priceRange" id="fashion_priceRange" onchange="this.form.submit()">
		...
		<option value="Greater than $500">Greater than $500</option>
			...
			<div class="well" style=" background: url(assests/img/furniturebg1.jpg) no-repeat center fixed; background-size: cover;">
        <!-- Projects Row -->
        <div class="row">
            ...
            <div class="col-md-2">
			  ...
			  else if($fashion_sort=="Select a value" && $fashion_subCategory=="Living" &&  $fashion_priceRange=="Select a value")
				  { echo "{$rowlaptops[0][3]}";}
			  else if($fashion_sort=="Select a value" && $fashion_subCategory=="Bedroom"  && $fashion_priceRange=="Select a value")
				  { echo "{$rowmobiles[0][3]}";}
